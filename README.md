...
## ***Known Issues***
- **Because the API keys will automatically get abandoned if they become publicly viewable, so we do not put API keys into our source code. However, the executable of the Python file and Unity project need API keys to work properly, I am sorry if you think this installation guide is complex, but I believe it is the only way.**
